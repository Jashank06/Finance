  ...
  return (
    <div className="investment-container">
      <div className="investment-header">
        ...
        <p>Calculate EMIs, amortization schedules, and manage your loans efficiently</p>
      </div>

      <div className="tabs-container">
        <div className="tabs">
          <button
            className={`tab-button ${view === 'calculator' ? 'active' : ''}`}
            onClick={() => setView('calculator')}
          >
            Calculator
          </button>
          <button
            className={`tab-button ${view === 'manage' ? 'active' : ''}`}
            onClick={() => {
              setView('manage');
          ...
          <div className="loan-content">
            ...
            <div className="investment-form-card">
              ...
              <div className="loan-form">
                ...
                <button className="btn-add-investment" style={{ width: '100%', justifyContent: 'center' }}>Calculate</button>
              </div>
            </div>
