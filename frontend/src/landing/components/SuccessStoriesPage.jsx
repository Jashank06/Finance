...
const SuccessStoriesPage = () => {
    ...
    const fetchSidebarStories = async () => {
        try {
            ...
            const allResponse = await axios.get(`${API_URL}/success-stories/public?limit=100`);
            setAllStories(allResponse.data.stories);

            // Fetch latest stories (sorted by date)
            const latestResponse = await axios.get(`${API_URL}/success-stories/public?limit=5&sort=date`);
            setLatestStories(latestResponse.data.stories);

            // Fetch popular stories (sorted by views)
            const popularResponse = await axios.get(`${API_URL}/success-stories/public?limit=5&sort=views`);
            setPopularStories(popularResponse.data.stories);
        } catch (error) {
            console.error('Error fetching sidebar stories:', error);
        }
    };

    const handleStoryClick = (slug) => {
        navigate(`/landing/success-stories/${slug}`);
    };
                ...
                <div className="success-layout">
                    ...
                    <aside className="success-sidebar">
                        ...
                        <div className="sidebar-section">
                            <h3 className="sidebar-title">View All Stories</h3>
                        ...
                        {/* Latest Stories */}
                        <div className="sidebar-section">
                            <h3 className="sidebar-title">Latest Stories</h3>
                            <ul className="sidebar-list">
                        ...
                        <div className="sidebar-section">
                            <h3 className="sidebar-title">Most Popular Stories</h3>
                            <ul className="sidebar-list">
